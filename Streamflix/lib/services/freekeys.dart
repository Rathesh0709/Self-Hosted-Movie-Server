...
/// Port of the `freekeys` npm package — a pool of public TMDB v3 keys.
/// Returns a random key so the app works out-of-the-box without the user
/// supplying their own. (Index varied per-call via a seeded RNG.)
const List<String> _tmdbKeys = [
...
String freeTmdbKey() => _tmdbKeys[Random().nextInt(_tmdbKeys.length)];
